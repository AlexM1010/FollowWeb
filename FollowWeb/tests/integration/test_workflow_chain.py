...
class TestWorkflowTriggers:
    ...
    def test_collection_to_validation_trigger(self, mock_checkpoint_data: dict[str, Any]):
...
class TestFailureScenarios:
    ...
    @pytest.mark.integration
    def test_failure_isolation_collection_fails(self, mock_checkpoint_data: dict[str, Any]):
    ...
    @pytest.mark.integration
    def test_failure_recovery_backup_created(self, mock_checkpoint_data: dict[str, Any]):
...
class TestDataContinuity:
    ...
    @pytest.mark.integration
    def test_duplicate_detection_across_runs(self, mock_checkpoint_data: dict[str, Any]):
    ...
    @pytest.mark.integration
    def test_repair_operations_preserve_data(self, mock_checkpoint_data: dict[str, Any]):
...
class TestCacheSharing:
    ...
    @pytest.mark.integration
    def test_cache_save_with_failure_recovery(self, mock_checkpoint_data: dict[str, Any]):
    ...
    @pytest.mark.integration
    def test_cache_restore_from_upstream_run(self, mock_checkpoint_data: dict[str, Any]):
