...
class TestGraphCheckpointSave:
    ...
    def test_save_creates_checkpoint(
        self, temp_checkpoint_path, sample_graph, sample_processed_ids
    ):
    ...
    def test_save_creates_parent_directory(
        self, tmp_path, sample_graph, sample_processed_ids
    ):
    ...
    def test_save_handles_io_error(
        self, mock_dump, temp_checkpoint_path, sample_graph, sample_processed_ids
    ):
    ...
    @patch("FollowWeb_Visualizor.data.checkpoint.joblib.dump")
    def test_save_uses_compression(
        self, mock_dump, temp_checkpoint_path, sample_graph, sample_processed_ids
    ):
...
class TestGraphCheckpointClear:
    ...
    def test_clear_handles_permission_error(
        self, temp_checkpoint_path, sample_graph, sample_processed_ids
    ):
