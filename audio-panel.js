                    ...
                    return `
                        <div class="mix-item expanded">
                            <div class="mix-header-row" onclick="window.audioPanel.toggleExpand('${id}')">
                                ...
                                <button class="btn-mini btn-danger" onclick="event.stopPropagation(); window.audioPanel.removeFromMix('${id}')">✖</button>
                            </div>
                            <div class="mix-expanded-content">
                                ...
                                <div class="mix-controls-row">
                                    ...
                                    <button class="btn-mini" onclick="window.audioPanel.stopPlayer('${id}')" title="Stop">⏹</button>
            ...
            panelContent.innerHTML = `
                <div class="mix-mode">
                    <div class="mix-header">
                        <div class="mix-title">🎵 Audio Mix (${playerIds.length})</div>
                        <div class="mix-master-controls">
                            <button class="btn-mini" onclick="window.audioPanel.playAll()" title="Play All">▶ All</button>
                            <button class="btn-mini" onclick="window.audioPanel.pauseAll()" title="Pause All">⏸ All</button>
                            <button class="btn-mini" onclick="window.audioPanel.stopAll()" title="Stop All">⏹ All</button>
